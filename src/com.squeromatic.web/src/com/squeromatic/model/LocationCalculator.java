...
public class LocationCalculator {
     ...
     * location fix.
     */
    public LocationCalculator(String provider) {
        mProvider = provider;
    }
     ...
     * location.
     */
    public LocationCalculator(LocationCalculator l) {
        set(l);
    }
     ...
     */
    public void set(LocationCalculator l) {
     ...
     */
    public float distanceTo(LocationCalculator dest) {
     ...
     */
    public float bearingTo(LocationCalculator dest) {
        synchronized (mResults) {
            // See if we already have the result
            if (mLatitude != mLat1 || mLongitude != mLon1 ||
                            dest.mLatitude != mLat2 || dest.mLongitude != mLon2) {
	...
	public static double distance(double startLatitude, double startLongitude,
			double endLatitude, double endLongitude) {
		LocationCalculator startLoc = new LocationCalculator();
		startLoc.setLatitude(startLatitude);
		startLoc.setLongitude(startLongitude);
		
		LocationCalculator endLoc = new LocationCalculator();
		endLoc.setLatitude(endLatitude);
		endLoc.setLongitude(endLongitude);
